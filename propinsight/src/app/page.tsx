...
function ProductCard({
  ...
  return (
    ...
    >
      <div
        className={`${bgColor} rounded-3xl p-6 md:p-8 min-h-[380px] md:min-h-[420px] flex flex-col relative overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-stone-200/50`}
      >
        {/* Decorative circles */}
