  ...
  return (
    <Link href={`/area/${area.slug}`} className="block">
      <motion.div
        ...
        className="group relative bg-white rounded-2xl border border-stone-200 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer"
      >
        {/* Map Preview */}
        <div className="relative h-48 bg-stone-100 overflow-hidden pointer-events-none">
        ...
        <div className="p-6 space-y-4">
          ...
          {/* CTA */}
          <div className="flex items-center justify-between w-full px-4 py-3 bg-sage-600 group-hover:bg-sage-700 text-white font-medium rounded-xl transition-all duration-200">
