          ...
          <>
            ...
            {stats.propertyTypeBreakdown &&
              (() => {
                ...
                const housesPercent =
                  total > 0 ? Math.round((houses / total) * 100) : 0;
                const apartmentsPercent =
                  total > 0 ? Math.round((apartments / total) * 100) : 0;
            ...
            >
              <div className="text-xs text-stone-500 font-medium px-3 pt-3 pb-1 flex-shrink-0">
                Price trend (3 years)
              </div>
